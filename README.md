...
- I really enjoyed learning about the npm packages that can easily work with express. Middleware is also pretty cool!

- [ ] Describe Middleware?
- Middleware is something that intercepts a process, does something (or nothing) and continues, or terminates the request. It can do (or not do) so many things ( logging all requests, authenticating users, simply routing the server to another route, etc. )

- [ ] Describe a Resource?
- A resource is the target of an HTTP request. Each resource is identified by a Uniform Resource Identifier (URI) used throughout HTTP for identifying resources.

- [ ] What can the API return to help clients know if a request was successful?
- STATUS CODES (200, 201, 202, 204 --> most common success codes)
